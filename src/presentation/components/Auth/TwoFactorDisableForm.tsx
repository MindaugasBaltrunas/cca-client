...
const TwoFactorDisableForm: React.FC = () => {
  ...
  if (user && !user.twoFactorEnabled) {
    return (
      <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md text-center">
        <h2 className="text-2xl font-bold mb-4">Two-Factor Authentication Not Enabled</h2>
        <p>You don't currently have two-factor authentication enabled on your account.</p>
      </div>
    );
  }
  ...
  if (disableComplete) {
    return (
      <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md text-center">
        <h2 className="text-2xl font-bold mb-4">Two-Factor Authentication Disabled</h2>
        <p className="mb-6">
          Two-factor authentication has been successfully disabled for your account.
        </p>
        <p className="text-sm text-gray-600 mb-4">
          Your account is now less secure. We recommend re-enabling two-factor authentication for optimal security.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-2 text-center">Disable Two-Factor Authentication</h2>
